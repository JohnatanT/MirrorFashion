...
<html>
  ...
  <body>
    ...
    <h1 id="mirror"> A Mirror Fashion </h1>
    ...
    <p> <strong>A Mirror Fashion</strong> é a maior empresa comércio eletrônico no segmento de moda em todo o mundo.
      ...
      <p>Fundada há <?php print date("Y") - 1932; ?> anos,...</p>
    ...
    <p> Nosso centro de distribuição fica em Jacarezinho, no Paraná. De lá, saem 48 aviões que
      ...
      <figure id="centro-distribuicao">
          ...
          <figcaption>Central de Distribuições da Mirror Fashion </figcaption>
      </figure>
    ...
    <figure id="familia-pelho">
        ...
        <figcaption> Familia Fundadora da Mirron Fashion</figcaption>
    </figure>
